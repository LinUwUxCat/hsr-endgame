...
export default function CurrentAA({aa} : CurrentAAProps) : ReactElement {
    ...
    return (
        <div style={{display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center"}}>
            <div style={{display: "grid", gridTemplateColumns: "repeat(3, 1fr)", width: "99vw", gap: "10px", marginBottom: "10px"}}>
            ...
            <div style={{display: "grid", gridTemplateColumns: "repeat(3, 1fr)", width: "99vw", gap: "10px"}}>
            ...
            <div style={{display: "grid", gridTemplateColumns: "repeat(2, 1fr)", width: "99vw", gap: "10px"}}>
                <div>
